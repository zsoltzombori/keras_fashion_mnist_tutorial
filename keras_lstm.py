# code taken directly from https://github.com/adventuresinML/adventures-in-ml-code/blob/master/keras_lstm.py
...
data_path = "/home/zombori/keras_fashion_mnist_tutorial/simple-examples/data"
